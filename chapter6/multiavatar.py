...
class INewUserAvatar(Interface):
    "should hava username attribute only"
...
class MultiAvatarRealm:
    ...
    def requestAvatar(self, avatarId, mind, *interfaces):
        logout = lambda: NotInmplementedError
...
class NamedUserLoginProtocol(basic.LineReceiver):
    ...
    def handle_pass(self, password):
        ...
        self.factory.portal.login(
            cred, None, *avatarInterfaces).addCallback(
